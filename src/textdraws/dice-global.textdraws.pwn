...
{
	DiceGlobalTextDraws[1-1] = TextDrawCreate(547.6665, 165.1110, "Box"); // РїСѓСЃС‚Рѕ
	...
	DiceGlobalTextDraws[2-1] = TextDrawCreate(589.6666, 279.5999, "SET_BET"); // РїСѓСЃС‚Рѕ
	...
	DiceGlobalTextDraws[3-1] = TextDrawCreate(589.6666, 291.6296, "DICE"); // РїСѓСЃС‚Рѕ
	...
	DiceGlobalTextDraws[4-1] = TextDrawCreate(589.6666, 307.0305, "EXIT"); // РїСѓСЃС‚Рѕ
	...
	DiceGlobalTextDraws[5-1] = TextDrawCreate(550.3331, 248.4888, "Bet:"); // РїСѓСЃС‚Рѕ
	...
	DiceGlobalTextDraws[6-1] = TextDrawCreate(550.3331, 256.2893, "Bank:"); // РїСѓСЃС‚Рѕ
	...
	DiceGlobalTextDraws[7-1] = TextDrawCreate(550.3331, 263.7897, "Balance:"); // РїСѓСЃС‚Рѕ
