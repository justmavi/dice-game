...
stock CreateDicePerTableTextdraws(tableid)
{
    ...
    DicePerTableTextDraws[tableid][0] = TextDrawCreate(549.4661, 187.9259, "1._--"); // пусто
    ...
    DicePerTableTextDraws[tableid][1] = TextDrawCreate(624.00, 188.00, "--"); // пусто
    ...
    DicePerTableTextDraws[tableid][2] = TextDrawCreate(549.7993, 196.9264, "2._--"); // пусто
    ...
    DicePerTableTextDraws[tableid][3] = TextDrawCreate(624.00, 197.00, "--"); // пусто
    ...
    DicePerTableTextDraws[tableid][4] = TextDrawCreate(549.7993, 205.5269, "3._--"); // пусто
    ...
    DicePerTableTextDraws[tableid][5] = TextDrawCreate(624.00, 205.00, "--"); // пусто
    ...
    DicePerTableTextDraws[tableid][6] = TextDrawCreate(549.7993, 214.3274, "4._--"); // пусто
    ...
    DicePerTableTextDraws[tableid][7] = TextDrawCreate(624.00, 214.00, "--"); // пусто
    ...
    DicePerTableTextDraws[tableid][8] = TextDrawCreate(549.7993, 223.8280, "5._--"); // пусто
    ...
    DicePerTableTextDraws[tableid][9] = TextDrawCreate(624.00, 224.00, "--"); // пусто
    ...
    DicePerTableTextDraws[tableid][10] = TextDrawCreate(628.0000, 256.5004, "0"); // пусто
    ...
    DicePerTableTextDraws[tableid][11] = TextDrawCreate(628.0000, 248.5000, "0"); // пусто
    ...
    DicePerTableTextDraws[tableid][12] = TextDrawCreate(571.3334, 164.2814, tableHeader); // пусто
